...
class Plate(defaultdict):
    """
    This class represents the plates that are filled with 4 tiles at the start
    of each round.
    """
    def __init__(self):
